...
def main():
    ...
    for account in range(0, 20):
        ...
        has_t_p2pkh_key = rand.bool()
        has_p2sh_key = (not has_t_p2pkh_key) and rand.bool()
        has_s_key = rand.bool()
        ...
        has_transparent = has_t_p2pkh_key or has_p2sh_key
        ...
        if has_t_p2pkh_key:
            ...
            t_fvk_bytes = bytes(t_account_key.public_key())
        ...
        if has_t_p2pkh_key:
            ...
            t_ivk_bytes = bytes(t_ivk_pubkey)
    ...
    render_tv(
        ...
        (
            ...
            ('p2sh_fvk_bytes',     {'rust_type': 'Option<Vec<u8>>', 'bitcoin_flavoured': False}),
            ...
            ('p2sh_ivk_bytes',     {'rust_type': 'Option<Vec<u8>>', 'bitcoin_flavoured': False}),
            ...
            ('cosigner_seed_1',    {'rust_type': 'Vec<u8>', 'bitcoin_flavoured': False}),
            ('cosigner_seed_2',    {'rust_type': 'Vec<u8>', 'bitcoin_flavoured': False}),
            ('account',            'u32'),
